...
if (output_sentiment_topic_positive.val !== undefined) {
     $("#output_sentiment_topic_positive").text("Topic positive is: null")
  }else{
    $("#output_sentiment_type_positive").text("Common positive sentiment: " + json.positive[1].sentiment)
 }
 if (output_text_topic_negative.val !== undefined) {
     $("#output_sentiment_topic_negative").text("Topic negative is: null")
  }else{
    $("#output_sentiment_type_negative").text("Common negative sentiment: " + json.negative[0].sentiment)
 }
  }
